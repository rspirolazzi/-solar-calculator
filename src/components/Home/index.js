...
import { RadiationSolar,Consume,SolaPanels,Batteries,Inverters,Cost} from '../Common/Icons'
...
const HomeCard =({title,subtitle,href,img})=><Card>
    ...
    <CardActions>
        <FlatButton label="Ingresar" href={href} />
    </CardActions>
</Card>
const homeSections=[
    ...
    {key:3,title:"Paneles Solares",subtitle:"Paneles solares seleccionados para la instalación",href:"/#solarPanel", img:<SolaPanels size="medium"/>},

...
export const SolarPanelHouse =(props)=><Img {...props} img={`house-solar-panel.png`}/>
export const SolarPanel =(props)=><Img {...props} img={`solar-panel.png`}/>
export const Batteries =(props)=><Img {...props} img={`light-connected-to-battery-and-solar-panel.png`}/>
export const Battery =(props)=><Img {...props} img={`battery.png`}/>
